...
export function getCivicGenes(): ICivicGene
{
    return {
        "PIK3CA": {
                ...
                url: "https://127.0.0.1/#/events/genes/37/summary",
        ...
        "RAF1": {
                ...
                name: "RAF1",
                description: "",
                url: "https://127.0.0.1/#/events/genes/4767/summary",
...
export function getCnaCivicVariants(): ICivicVariant
{
    return {
        "RAF1": {"AMPLIFICATION": {
                                   ...
                                   geneId: 4767,
                                   description: "",
                                   url: "https://127.0.0.1/#/events/genes/4767/summary/variants/591/summary#variant",
...
export function getMutationCivicVariants(): ICivicVariant
{
    return {
        "PIK3CA": { "E545K": {
                             ...
                             url: "https://127.0.0.1/#/events/genes/37/summary/variants/104/summary#variant",
