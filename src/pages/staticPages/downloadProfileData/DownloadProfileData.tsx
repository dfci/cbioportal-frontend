            ...
            <PageLayout className={'whiteBackground staticPage'}>
                ...
                <div>
                    <p style={{
                        ...
                        lineHeight: '28px',
                        fontWeight: 100
                    }}> Registered users can now download all de-identified Profile Data. Please review the terms of
                        access below. Note that these terms are identical to the terms of access you agreed to upon
                        registration.</p><br/>
                    <p style={{
                        fontFamily: '"Roboto", sans-serif',
                        fontWeight: 900,
                    ...
                    }}>I agree not to redistribute cBioPortal data, either internally or externally.<span
                        style={{color: 'red', display: 'inline'}}>*</span></p>
                    <p style={{
                        fontFamily: '"Roboto", sans-serif',
                        fontWeight: 100,
                        color: 'grey',
                    ...
                    <p style={{
                        ...
                        lineHeight: '22px',
                        fontSize: '18px !important'
                    }}>I agree not to use any data within the portal to re-identify a patient.<span
                        style={{color: 'red', display: 'inline'}}>*</span></p>
                    <p style={{
                        fontFamily: '"Roboto", sans-serif',
                        fontWeight: 100,
                    ...
                    <p style={{
                        ...
                        lineHeight: '22px',
                        fontSize: '18px !important'
                    }}>I agree to contact and receive approval from the appropriate Data Use Committee through OncDRS
                        prior to publishing any results derived from cBioPortal or Profile.<span
                            style={{color: 'red', display: 'inline'}}>*</span></p>
                    <p style={{
                        fontFamily: '"Roboto", sans-serif',
                        fontWeight: 100,
